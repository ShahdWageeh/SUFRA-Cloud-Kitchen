...
const translations = {
  ...
  "This chef profile is unavailable right now.": "ملف هذا الطاهي غير متاح حاليًا.",
  ...
  "No reviews yet for this meal. Be the first to try it!": "لا توجد تقييمات لهذه الوجبة بعد. كن أول من يجربها!",
  "Freshly prepared favorites from the same kitchen.": "أطباق مفضلة محضرة طازجة من نفس المطبخ.",
  ...
  "No verified chefs available right now.": "لا يوجد طهاة موثقون متاحون حاليًا.",
  "No meal recommendations available right now.": "لا توجد ترشيحات وجبات متاحة حاليًا.",
  ...
  "Once you complete orders, your earnings will appear here.": "ستظهر أرباحك هنا بعد إكمال الطلبات.",
  "When you request a payout, it will show up here for tracking.": "ستظهر طلبات السحب هنا للمتابعة.",
  "Please enter a valid amount greater than zero": "يرجى إدخال مبلغ صحيح أكبر من صفر",
  "Withdrawal amount cannot exceed available balance": "لا يمكن أن يتجاوز مبلغ السحب الرصيد المتاح",
  "Withdrawal request submitted successfully!": "تم إرسال طلب السحب بنجاح!",
  "Failed to load revenue data. Please try again later.": "تعذر تحميل بيانات الإيرادات. حاول مرة أخرى لاحقًا.",
  ...
  "Remove": "إزالة",
  "Please provide shipping address and contact phone": "يرجى إدخال عنوان التوصيل ورقم الهاتف",
  ...
  "Street name, Building number, Apartment...": "اسم الشارع، رقم المبنى، الشقة...",
  ...
  "Category *": "التصنيف *",
  "Ingredients (Separated by comma or Enter)": "المكونات (افصل بفاصلة أو Enter)",
  ...
  "Celebrating home-cooked heritage and authentic flavors from local chefs around the world.": "نحتفي بتراث الأكل البيتي والنكهات الأصيلة من الطهاة المحليين.",
  "© 2026 Sufra. All Rights Reserved.": "© 2026 سفرة. جميع الحقوق محفوظة.",
  "Taste The Love Of Home": "تذوق حب أكل البيت",
  "Discover authentic home-cooked meals prepared by talented local chefs and delivered fresh to your door.": "اكتشف وجبات منزلية أصيلة يحضرها طهاة محليون موهوبون وتصل طازجة إلى بابك.",
  "How Sufra Works": "كيف تعمل سفرة",
  "Explore hundreds of home-cooked dishes from local chefs.": "استكشف مئات الأطباق المنزلية من طهاة محليين.",
  "Securely place your order and choose delivery or pickup.": "اطلب بأمان واختر التوصيل أو الاستلام.",
  "Experience authentic homemade meals with every bite.": "استمتع بوجبات منزلية أصيلة مع كل لقمة.",
  "Powered by Matbakhna AI": "مدعوم بذكاء مطبخنا الاصطناعي",
  "Your Smart Culinary Assistant": "مساعدك الذكي للطهي",
  "Our AI Meal Planner learns your tastes and suggests perfect home-cooked meals based on your dietary needs and history. Get smart recommendations that feel like they were made just for you.": "يتعلم مخطط الوجبات الذكي ذوقك ويقترح وجبات منزلية مثالية بناءً على احتياجاتك الغذائية وتفضيلاتك. احصل على ترشيحات ذكية مصممة خصيصًا لك.",
  ...
  "Finally, food that actually tastes like my grandmother's cooking. No commercial restaurant can replicate this level of soul and tradition.": "أخيرًا، طعام يشبه فعلًا طهي جدتي. لا يستطيع أي مطعم تجاري تقديم هذا القدر من الروح والأصالة.",
  "Becoming a chef on Matbakhna changed my life. I can share my heritage and support my family from my own kitchen.": "الانضمام كطاهية على مطبخنا غيّر حياتي. أستطيع مشاركة تراثي ودعم أسرتي من مطبخي.",
  "The AI planner is surprisingly accurate! It introduced me to dishes I'd never tried before but now absolutely love.": "مخطط الوجبات الذكي دقيق بشكل مدهش! عرّفني على أطباق لم أجربها من قبل وأصبحت أحبها جدًا.",
  "Authentic & Community-led": "أصيل ويقوده المجتمع",
  "Bringing the Soul of Home Cooking to Your Table.": "نقدم روح أكل البيت إلى مائدتك.",
  "Sufra lets talented home chefs share their heritage through fresh, soulful meals. We bring neighbors together around food that feels personal, warm, and full of care.": "تتيح سفرة للطهاة المنزليين الموهوبين مشاركة تراثهم من خلال وجبات طازجة ومليئة بالروح. نجمع الجيران حول طعام شخصي ودافئ ومحضّر بكل عناية.",
  "Meet Our Chefs": "تعرّف على طهاتنا",
  "Join Our Mission": "انضم إلى رسالتنا",
  "From a small family table to a trusted local movement, our journey began with one simple idea: food made at home carries memory.": "من مائدة عائلية صغيرة إلى مجتمع محلي موثوق، بدأت رحلتنا بفكرة بسيطة: الطعام المصنوع في البيت يحمل الذكريات.",
  "We started when our founders, realized how many gifted home cooks were preparing extraordinary meals without a platform to reach nearby food lovers. Sufra became that bridge.": "بدأنا عندما أدرك مؤسسونا أن كثيرًا من الطهاة المنزليين الموهوبين يقدمون وجبات رائعة دون منصة تصلهم بمحبي الطعام القريبين. أصبحت سفرة هذا الجسر.",
  "Local sourcing and home-based kitchens reduce waste and support neighborhood economies.": "المكونات المحلية والمطابخ المنزلية تقلل الهدر وتدعم اقتصاد الأحياء.",
  "2,000+ Chefs": "أكثر من 2,000 طاهٍ",
  "Empowering passionate cooks to earn from the recipes they love most.": "نساعد الطهاة الشغوفين على تحقيق دخل من الوصفات التي يحبونها.",
  "Every order helps preserve culture, support cooks, and build local connection.": "كل طلب يساعد في حفظ الثقافة ودعم الطهاة وبناء روابط محلية.",
  "Strict Vetting": "مراجعة دقيقة",
  "Every chef completes our kitchen, food-safety, and authenticity review before joining the community.": "يخضع كل طاهٍ لمراجعة المطبخ وسلامة الغذاء والأصالة قبل الانضمام إلى المجتمع.",
  "Heritage Recipes": "وصفات تراثية",
  "We celebrate family recipes, local ingredients, and the traditions that make every dish personal.": "نحتفي بوصفات العائلة والمكونات المحلية والتقاليد التي تجعل كل طبق مميزًا.",
  "Safety First": "السلامة أولًا",
  "Transparent profiles, verified cooks, and careful handling standards keep every order dependable.": "الملفات الواضحة والطهاة الموثقون ومعايير التعامل الدقيقة تجعل كل طلب موثوقًا.",
  "\"We are building a world where every kitchen is a gateway to a different culture.\"": "\"نبني عالمًا يصبح فيه كل مطبخ بوابة إلى ثقافة مختلفة.\"",
  "- Mustafa, Founder & CEO": "- مصطفى، المؤسس والرئيس التنفيذي",
  "Sufra was founded on the belief that the best meals are cooked by people who carry stories, tradition, and pride into every dish.": "تأسست سفرة على إيمان بأن أفضل الوجبات يصنعها أشخاص يضعون القصص والتقاليد والفخر في كل طبق.",
  "Join our community of local chefs and neighbors discovering food made with heritage, care, and soul.": "انضم إلى مجتمعنا من الطهاة المحليين والجيران لاكتشاف طعام مصنوع بالتراث والعناية والروح.",
  "Start Browsing Today": "ابدأ التصفح اليوم",
  "Get in Touch": "تواصل معنا",
  "Questions, partnerships, or support? Our community team is here to help.": "لديك أسئلة أو شراكة أو تحتاج دعمًا؟ فريق المجتمع هنا لمساعدتك.",
  "Need help navigating Matbakhna or managing an order? Send us a message.": "تحتاج مساعدة في استخدام مطبخنا أو إدارة طلب؟ أرسل لنا رسالة.",
  "Questions about chef partnerships, feedback, or general inquiries.": "أسئلة عن شراكات الطهاة أو الملاحظات أو الاستفسارات العامة.",
  ...
  "Find answers to the most common questions from our community.": "اعثر على إجابات لأكثر أسئلة مجتمعنا شيوعًا.",
  "How do I join as a Chef?": "كيف أنضم كطاهٍ؟",
  "Apply online, share your food story, and our team will guide you through kitchen verification.": "قدم طلبك عبر الإنترنت وشارك قصة طعامك، وسيرشدك فريقنا خلال توثيق المطبخ.",
  "Is the food safety guaranteed?": "هل سلامة الطعام مضمونة؟",
  "We review chef profiles, kitchen standards, and customer feedback to keep trust at the center.": "نراجع ملفات الطهاة ومعايير المطابخ وآراء العملاء للحفاظ على الثقة.",
  "What is your response time?": "ما مدة الرد؟",
  "Most messages receive a response within one business day from our community support team.": "يتم الرد على معظم الرسائل خلال يوم عمل واحد من فريق دعم المجتمع.",
  "Can I visit your office?": "هل يمكنني زيارة مكتبكم؟",
  "Visits are available by appointment at ITI Cairo University for partners and community members.": "الزيارات متاحة بموعد مسبق في ITI بجامعة القاهرة للشركاء وأعضاء المجتمع.",
  "Failed to send message": "تعذر إرسال الرسالة",
  "Matbakhna social channel": "قناة مطبخنا الاجتماعية",
  ...
  "Moderation": "الإشراف",
  "Authentic home-cooked meals from the best chefs in your neighborhood.": "وجبات منزلية أصيلة من أفضل الطهاة في منطقتك.",
  "Cuisine": "المطبخ",
  "Price": "السعر",
  "Rating": "التقييم",
  "Levantine": "شامي",
  ...
  "Maghrebi": "مغاربي",
  "More": "المزيد",
  "Home chefs trusted by Sarah and your neighbors": "طهاة منزليون تثق بهم سارة وجيرانك",
...
const dynamicTranslations = [
  ...
  [/^Home chefs trusted by\s+(.+)\s+and your neighbors$/i, "طهاة منزليون يثق بهم $1 وجيرانك"],
  [/^(\d+(?:\.\d+)?)\s+km away$/i, "يبعد $1 كم"],
  [/^by\s+(.+)$/i, "بواسطة $1"],
  [/^Remove\s+(.+)$/i, "إزالة $1"],
  [/^Upload\s+(.+)$/i, "رفع $1"],
  [/^Welcome back to control center,\s*(.+)$/i, "مرحبًا بعودتك إلى مركز التحكم، $1"],
...
function renderElement(element, language) {
  ...
  ["placeholder", "aria-label", "title", "alt"].forEach((attribute) => {
    ...
    if (stored[attribute] !== undefined) {
      element.setAttribute(attribute, language === "ar" ? translate(stored[attribute]) : stored[attribute]);
    }
  });
...
export default function ArabicLocalizationProvider({ children }) {
    ...
    const observer = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.type === "characterData") {
          ...
          const expected = original && language === "ar" ? translate(original) : original;
  ...
  return (
    <>
      ...
      >
        <span className={language === "ar" ? "language-option active" : "language-option"}>
          العربية
        </span>
        <span className="language-divider" aria-hidden="true" />
        <span className={language === "en" ? "language-option active" : "language-option"}>
          English
        </span>
      </button>
    </>
