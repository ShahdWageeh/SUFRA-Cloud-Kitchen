...
const sectionTitles = [
  { key: "/delivery/dashboard", title: "Dashboard" },
  { key: "/delivery/current-order", title: "Current order" },
  { key: "/delivery/history", title: "history" },
  { key: "/delivery/profile", title: "Profile" },
];
...
function getSectionTitle(pathname) {
  ...
  return match?.title ?? "Delivery Portal";
}

export default function DeliveryTopbar({ onMenuClick }) {
